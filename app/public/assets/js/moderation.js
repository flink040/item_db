...
(function () {
  ...
  function normalizeCreator(data) {
    const candidates = [
      data && data.profiles && data.profiles.mc_name,
      data && data.profiles && data.profiles.mcName,
      ...
      data && data.creator && data.creator.mc_name,
      data && data.creator && data.creator.mcName,
      data && data.creator && data.creator.username,
      data && data.creator && data.creator.display_name,
      data && data.creator && data.creator.name,
      data && data.created_by && data.created_by.mc_name,
      data && data.created_by && data.created_by.mcName,
      ...
      data && data.owner && data.owner.mc_name,
      data && data.owner && data.owner.mcName,
